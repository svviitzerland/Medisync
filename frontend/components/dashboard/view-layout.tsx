...
export function ViewLayout({
  ...
  return (
    <div
      className={cn("flex flex-col lg:flex-row gap-8 items-start", className)}
    >
      {children}
    </div>
  );
...
export function ViewHeader({
  ...
  return (
    <div
      className={cn(
        "mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4",
        className,
      )}
    >
      <div>
...
export function ViewContentCard({
  ...
  return (
    <div
      className={cn(
        "space-y-8 rounded-2xl border border-border/40 bg-card/60 backdrop-blur-md p-6 sm:p-8 shadow-sm",
        className,
      )}
    >
      {children}
...
export function ViewSidebar({
  ...
  return (
    <div
      className={cn(
        "w-full lg:w-100 shrink-0 space-y-4 lg:sticky lg:top-4",
        className,
      )}
    >
      {children}
